...
WorkingStudent::WorkingStudent(char* name, int id, float average, int num_of_courses,int days, char* name_of_teza, int seniority, int weekly_hours) :Person(name, id), Student(name, id, average, num_of_courses, days),Employee(name,id, seniority), MA(name, id, average, num_of_courses,days, name_of_teza), Practitioner(name,id,weekly_hours,seniority)
{
}
